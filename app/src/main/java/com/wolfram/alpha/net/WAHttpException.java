...
/**
 * Either has httpStatusCode member set to a value other than HttpStatus.SC_OK
 * or wraps another exception such as IOException or HttpException.
 * 
 * @author tgayley
 * 
 */
public class WAHttpException extends Exception {
	...
	// Do not add other constructors without reviewing uses of
	// HttpHandlerException,
	// especially in Mathematica PacletManager code. Code depends on the
	// assumption that all these
	// exceptions either have httpStatusCode != SC_OK, or they wrap another
	// exception.
