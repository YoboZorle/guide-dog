...
public class J2SEHttpTransaction implements HttpTransaction {
	...
	public String getResponseString() throws IOException {
		...
		// Because we cast to int, will fail for huge downloads (>2Gb), but
		// those wouldn't fit into
		...
		outStrm.close();
		try {
			// For general-purpose use, would want to replace hard-coded
			// ISO-8859-1 with value determined from response.
