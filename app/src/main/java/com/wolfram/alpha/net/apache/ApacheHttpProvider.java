...
public class ApacheHttpProvider implements HttpProvider {
	...
	// This is how long to wait for data after the connection is made. Has to be
	// long enough to
	// accommodate query-type URLs that do work on the server before returning
	// any data.
	...
	static {
		...
		// Retry handler? See
		// http://hc.apache.org/httpcomponents-client/tutorial/html/fundamentals.html#d4e37
	...
	public HttpTransaction createHttpTransaction(URL url,
		...
		return new ApacheHttpTransaction(httpClient, url, proxySettings,
				MAX_RETRY_COUNT, socketTimeoutMillis);
	}
	...
	public void setProxyInfo(int useProxy, String httpProxyHost,
			int httpProxyPort, String socksProxyHost, int socksProxyPort) {
