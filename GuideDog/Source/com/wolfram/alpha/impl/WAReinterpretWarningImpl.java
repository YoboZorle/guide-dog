...
public class WAReinterpretWarningImpl extends WAWarningImpl implements
		WAReinterpretWarning, Serializable {
	...
	WAReinterpretWarningImpl(Element thisElement) throws WAException {
		...
		NodeList alternativeNodes = thisElement
		...
		for (int i = 0; i < numAlternatives; i++)
			alternatives[i] = alternativeNodes.item(i).getFirstChild()
					.getNodeValue();
	}
