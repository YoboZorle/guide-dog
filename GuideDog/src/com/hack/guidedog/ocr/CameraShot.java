...
public class CameraShot extends Activity {
	...
	public static final String PACKAGE_NAME = "com.sv.ocr";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.buttonDetect).setOnClickListener(
				new OnClickListener() {

					@Override
					public void onClick(View v) {
						// TODO Auto-generated method stub
						startActivity(new Intent(CameraShot.this,
								FaceDetectionActivity.class));
					}
				});
		_field = (EditText) findViewById(R.id.fieldOcr);
		_button = (Button) findViewById(R.id.buttonOcr);
	...
	protected void onSaveInstanceState(Bundle outState) {
		outState.putBoolean(CameraShot.PHOTO_TAKEN, _taken);
	}

	@Override
	protected void onRestoreInstanceState(Bundle savedInstanceState) {
		Log.i(TAG, "onRestoreInstanceState()");
		if (savedInstanceState.getBoolean(CameraShot.PHOTO_TAKEN)) {
			onPhotoTaken();
		}
	}
